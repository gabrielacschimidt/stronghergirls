...
function testimonialsSlider() {
    var historyimages = jQuery('.testimonials');
...
function historySlider2() {
    //History Images slide
    var historyimages = jQuery('#history-images-2');
    if (historyimages.length > 0) {
        historyimages.owlCarousel({
            singleItem: true,
            pagination: false,
...
$(function(){
    /*ajax form submission for sontact and sign up form*/
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.status == "success"){
                    ...
                    $(".ajaxForm .alert-success").fadeIn();
                }else{
                    // alert("An error occured.");
                    $(".ajaxForm .alert-danger").fadeIn();
                }
            }
        });
    });
